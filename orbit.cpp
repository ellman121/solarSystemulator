...
void InitSolarSystem(){
	...
	satellites.clear();
	moonMap.emplace("Luna", new planet("Luna", "Earth",1738, 384400, 27.322, 27.3, 0, moonColor, nullImage, satellites));
	...
	moonMap.emplace("Adrastea", new planet("Adrastea", "Jupiter", 208, 128980, 0.298, 7.152, 0.03, moonColor, nullImage, satellites));
	moonMap.emplace("Amalthea", new planet("Amalthea", "Jupiter", 83.5, 181300, 0.498, 11.952, 0.374, moonColor, nullImage, satellites));
	moonMap.emplace("Callisto", new planet("Callisto", "Jupiter", 2400, 1883000, 16.689, 400.536, 0.205, moonColor, nullImage, satellites));
	moonMap.emplace("Europa", new planet("Europa", "Jupiter", 1563, 670900, 3.551, 85, 0.471, moonColor, nullImage, satellites));
	moonMap.emplace("Ganymede", new planet("Ganymede", "Jupiter", 2638, 1070000, 7.155, 171.72, 0.204, moonColor, nullImage, satellites));
	moonMap.emplace("Io", new planet("Io", "Jupiter", 1814.5, 421600, 1.769, 42.456, 0.05, moonColor, nullImage, satellites));
	moonMap.emplace("Metis", new planet("Metis", "Jupiter", 20, 127960, 0.295, 7.08, 0.06, moonColor, nullImage, satellites));
	moonMap.emplace("Thebe", new planet("Thebe", "Jupiter", 50, 221900, 0.675, 16.2, 1.076, moonColor, nullImage, satellites));
